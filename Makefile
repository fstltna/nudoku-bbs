...
pkgdatadir = $(datadir)/nudoku
pkgincludedir = $(includedir)/nudoku
pkglibdir = $(libdir)/nudoku
pkglibexecdir = $(libexecdir)/nudoku
...
ACLOCAL = ${SHELL} /sbbs/doors/nudoku-bbs/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /sbbs/doors/nudoku-bbs/missing autoconf
AUTOHEADER = ${SHELL} /sbbs/doors/nudoku-bbs/missing autoheader
AUTOMAKE = ${SHELL} /sbbs/doors/nudoku-bbs/missing automake-1.15
AWK = mawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /sbbs/doors/nudoku-bbs/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = nudoku
PACKAGE_BUGREPORT = jubalh@iodoru.org
PACKAGE_NAME = nudoku
PACKAGE_STRING = nudoku 1.0.0
PACKAGE_TARNAME = nudoku
PACKAGE_URL = 
...
STRIP = 
VERSION = 1.0.0
abs_builddir = /sbbs/doors/nudoku-bbs
abs_srcdir = /sbbs/doors/nudoku-bbs
abs_top_builddir = /sbbs/doors/nudoku-bbs
abs_top_srcdir = /sbbs/doors/nudoku-bbs
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /sbbs/doors/nudoku-bbs/install-sh
